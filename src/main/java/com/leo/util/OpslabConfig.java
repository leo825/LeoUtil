...
public class OpslabConfig {
    ...
    static {
        ...
        try (InputStream inputStream = contextClassLoader.getResource("application.properties").openStream()) {
            ...
            //获取非jar包内的配置信息
            try {
                String config_file = new File(contextClassLoader.getResource("application.properties").toURI()).getPath();
