...
public class ClassUtilTest {
    ...
    public void testPrivateMetod()  {
        ...
        String[] methods = ClassUtil.getPrivateMethod("com.leo.util.bean.BeanUtil");
    ...
    public void testProtectedMetod()  {
        ...
        String[] methods = ClassUtil.getProtectedMethod("com.leo.util.bean.BeanUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=============获取自定义的和继承的Protected类型的方法==========");
        methods = ClassUtil.getProtectedMethod("com.leo.util.bean.BeanUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
    }
    ...
    public void testPublicMetod()  {
        ...
        String[] methods = ClassUtil.getPublicMethod("com.leo.util.bean.BeanUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=============获取自定义的和继承的public类型的方法==========");
        methods = ClassUtil.getPublicMethod("com.leo.util.bean.BeanUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
    }
    ...
    public void testMetod() throws  InvocationTargetException, IllegalAccessException {
        ...
        String[] methods = ClassUtil.getMethod("com.leo.util.StringUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=========自定义的方法和继承来的方法===========");
        methods = ClassUtil.getMethod("com.leo.util.StringUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
